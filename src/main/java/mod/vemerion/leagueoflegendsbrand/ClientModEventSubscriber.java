...
import mod.vemerion.leagueoflegendsbrand.renderer.ConflagrationRenderer;
...
public class ClientModEventSubscriber {
	...
	public static void onRegisterRenderer(FMLClientSetupEvent event) {
		...
		RenderingRegistry.registerEntityRenderingHandler(LeagueOfLegendsBrand.CONFLAGRATION_ENTITY,
				(renderManager) -> new ConflagrationRenderer(renderManager));
